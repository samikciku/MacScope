...
final class MemoryViewModel: ObservableObject {
    ...
    private let monitor: any MemoryMonitorProtocol
    private var historyBuffer = RingBuffer<MemoryStats>(capacity: 300)

    init(monitor: any MemoryMonitorProtocol = MemoryMonitor()) {
